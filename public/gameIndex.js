...
/***/ "./src/blur-background.ts":
/*!********************************!*\
  !*** ./src/blur-background.ts ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   addBlurBackground: () => (/* binding */ addBlurBackground),\n/* harmony export */   removeBlurBackground: () => (/* binding */ removeBlurBackground)\n/* harmony export */ });\nfunction addBlurBackground() {\n    document.body.classList.add('blurElement');\n}\nfunction removeBlurBackground() {\n    document.body.classList.remove('blurElement');\n}\n\n\n//# sourceURL=webpack://jogo-da-memoria/./src/blur-background.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   removeFinishBtn: () => (/* binding */ removeFinishBtn),\n/* harmony export */   renderFinishBtn: () => (/* binding */ renderFinishBtn),\n/* harmony export */   renderGamemodeOptions: () => (/* binding */ renderGamemodeOptions),\n/* harmony export */   renderGameoverOptions: () => (/* binding */ renderGameoverOptions)\n/* harmony export */ });\n/* harmony import */ var _blur_background__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blur-background */ \"./src/blur-background.ts\");\n/* harmony import */ var _create_elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./create-elements */ \"./src/create-elements.ts\");\n/* harmony import */ var _Game__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Game */ \"./src/Game.ts\");\n\n\n\nvar gameDifficulty;\nvar game;\n/* Renderiza a tela para escolher o modo de jogo. */\nfunction renderGamemodeOptions() {\n    var sectionOpt = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.createElement)('section', '', 'game-options');\n    var p = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.newTextElement)('p', 'Selecione a dificuldade');\n    var btnContainer = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.createElement)('div', '', 'btn-container');\n    var easyBtn = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.newButton)('Easy', '', 'easy-btn', 'mode-btn');\n    easyBtn.dataset.difficulty = 'easy';\n    var mediumBtn = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.newButton)('Medium', '', 'medium-btn', 'mode-btn');\n    mediumBtn.dataset.difficulty = 'medium';\n    var hardBtn = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.newButton)('Hard', '', 'hard-btn', 'mode-btn');\n    hardBtn.dataset.difficulty = 'hard';\n    btnContainer.append(easyBtn, mediumBtn, hardBtn);\n    sectionOpt.append(p, btnContainer);\n    document.body.appendChild(sectionOpt);\n    document.querySelectorAll('.mode-btn').forEach(function (btn) {\n        btn.addEventListener('click', function () {\n            gameDifficulty = btn.dataset.difficulty;\n            sectionOpt.remove();\n            game = new _Game__WEBPACK_IMPORTED_MODULE_2__.Game(gameDifficulty);\n        }, { once: true });\n    });\n}\n/* Renderiza a tela de fim de jogo. */\nfunction renderGameoverOptions() {\n    var sectionOpt = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.createElement)('section', '', 'game-options');\n    var p = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.newTextElement)('p', 'Fim de jogo');\n    var btnContainer = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.createElement)('div', '', 'btn-container');\n    var playAgainBtn = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.newButton)('Play again', '', 'play-again-btn', 'opt-btn');\n    var changeModeBtn = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.newButton)('Change mode', '', 'change-mode-btn', 'opt-btn');\n    var ExitBtn = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.newButton)('Exit', '', 'exit-btn', 'opt-btn');\n    btnContainer.append(playAgainBtn, changeModeBtn, ExitBtn);\n    sectionOpt.append(p, btnContainer);\n    document.body.appendChild(sectionOpt);\n    playAgainBtn.addEventListener('click', function () {\n        sectionOpt.remove();\n        game.restartGame();\n    }, { once: true });\n    changeModeBtn.addEventListener('click', function () {\n        sectionOpt.remove();\n        renderGamemodeOptions();\n    }, { once: true });\n    ExitBtn.addEventListener('click', function () {\n        var a = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.newAnchorElement)('index.html');\n        a.click();\n    }, { once: true });\n}\n/* Renderiza o botão que finaliza o jogo caso seja clicado. */\nfunction renderFinishBtn() {\n    var finishButton = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.newButton)('Finish Game', '', 'finish-game-btn');\n    document.body.appendChild(finishButton);\n    finishButton.addEventListener('click', renderConfirmScreen);\n}\n/* Remderiza a tela de confirmação para finalizar o jogo. */\nfunction renderConfirmScreen() {\n    var confirmSection = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.createElement)('section', 'confirm-section', 'game-options');\n    var p = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.newTextElement)('p', 'Encerrar o jogo?');\n    var btnContainer = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.createElement)('div', '', 'btn-container');\n    var yesButton = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.newButton)('Yes', '', 'opt-btn');\n    var noButton = (0,_create_elements__WEBPACK_IMPORTED_MODULE_1__.newButton)('No', '', 'opt-btn');\n    yesButton.addEventListener('click', function () {\n        confirmSection.remove();\n        game.finishGame();\n        (0,_blur_background__WEBPACK_IMPORTED_MODULE_0__.removeBlurBackground)();\n    });\n    noButton.addEventListener('click', function () {\n        confirmSection.remove();\n        (0,_blur_background__WEBPACK_IMPORTED_MODULE_0__.removeBlurBackground)();\n    });\n    btnContainer.append(yesButton, noButton);\n    confirmSection.append(p, btnContainer);\n    document.body.appendChild(confirmSection);\n    (0,_blur_background__WEBPACK_IMPORTED_MODULE_0__.addBlurBackground)();\n}\nfunction removeFinishBtn() {\n    document.querySelector('.finish-game-btn').remove();\n}\n\n\n//# sourceURL=webpack://jogo-da-memoria/./src/options-screens.ts?");
